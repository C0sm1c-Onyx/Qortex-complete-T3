...
class AlbumTrack(models.Model):
    ...
    track = models.ForeignKey(Music, on_delete=models.CASCADE, related_name="album_tracks")
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(fields=["album", "track_number"], name="uniq_track_number_per_album"),
            models.UniqueConstraint(fields=["album", "track"], name="uniq_track_per_album"),
        ]
